...
["Wet:Dry CI Spread",
  ...
  ["CI date", selectedPlant.ci_date]
    ...
    if (permit){
      ...
      action.className = "detailActions";
      action.style.gridColumn = "1 / -1";

      const btn = document.createElement("button");
      btn.type = "button";
      btn.className = "secondaryButton";
      btn.textContent = "Operating Detail";
      btn.addEventListener("click", () => setOperatingDetailOpen(true));

      action.appendChild(btn);
      kv.appendChild(action);
    }
